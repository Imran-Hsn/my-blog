...
<div class="container-fluid overflow-hidden">
    <!-- <div class="row g-2"> -->
        <div style="width: 30%; height: 120px;" class="bg-dark text-white d-inline-block position-relative p-3  m-1 col border border-dark rounded rounded-3 align-items-center">
